...
from icon.geometry.geometry import Circle, Trapeze, Rhombus, Triangle, Square, Pentagon, Hexagon, Septagon, Ntagon
    ...
    def create(self, path):
        ...
        for key, value in self.__colors.items():
            ...
            for figure in self.__figures:
                ...
                num += 1
                image.save(path + format(num, '02d') + '.png', dpi=(600, 600), format='PNG', subsampling=0, quality=100)