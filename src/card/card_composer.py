...
class Card_Composer:
    ...
    def generate(self, source_images, output_path="maxfilled_layers.png"):
        canvas = Image.new("RGBA", (self.__canvas_size, self.__canvas_size), (255,255,255,255))
        placed = []
        ...
        for i, (img_path, scale) in enumerate(zip(source_images, scales)):
        ...
        draw.ellipse((2,2,self.__canvas_size-2,self.__canvas_size-2), outline=(0,0,0,255), width=3)
